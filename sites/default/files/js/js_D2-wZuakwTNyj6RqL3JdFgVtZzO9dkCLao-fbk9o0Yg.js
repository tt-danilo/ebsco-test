            ...
            item.forEach((item) => {
              $(
                '<div class="card-item">' +
                  ...
                  '">' +
                  '<div class"item-title"><span class="text-bold">Title: </span>' +
                  item.volumeInfo.title +
                  "</div>" +
                  '<div class="item-author"><span class="text-bold">Author: </span>' +
                  item.volumeInfo.authors +
                  "</div>" +
                  '<div class="item-description"><span class="text-bold">Description: </span>' +
                  item.volumeInfo.description +
                  "</div>" +
                  '<div><a class="more-info" href="' +
